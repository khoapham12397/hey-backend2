...
import com.hey.model.ChatMessageSendP2P;
...
public class WalletPublicHandler {
	...
	public WalletPublicHandler(WalletService walletService) {
	 	...
	 	String path = StringUtils.substringAfter(requestPath, "/api/wallet/public");
            		...
            		switch(path) {
            			...
            			case "/check2User":
            				...
            				break;
            			case "/checkCallService":
            				break;
            			case "/delAllPresent":
            				delAllPresent(request, response, jsonObject, userId);
            				break;
            			case "/delAllMsgPresent":
            				delAllMsgPresent(request, response, jsonObject, userId);
            				break;
            			case "/registerWallet":
	...
	public void receivePresent(HttpServerRequest request , HttpServerResponse response,JsonObject jsonObject ,String userId) {
		...
		userId = "f22a7779-807c-40e7-9f35-f76b78c2aea2";
		// neu ma random :
