...
public class APIService extends BaseService{
    ...
    public Future<List<FriendList>> getFriendLists(String userId) {
        ...
        System.out.println("GET FRIENDLIST OF USER ID: " + userId);
        String keyPattern = "friend:list:*" + userId + "*";
       
        // thi bat buoc pass vao 1 cai instance nao do dung vya do de cho
        ...
        getKeysByPatternFuture.compose(keys -> {
            ...
            cp.setHandler(ar -> {
                if (ar.succeeded()) {
                	// tai sao o day no ko dung ar ??
                	// dung vay do : and something like thi s: /// 
    ...
    public Future<UserProfileResponse> getUserProfile(String userId) {
        ...
        cp.setHandler(ar -> {
            if (ar.succeeded()) {
                ...
                System.out.println("<user status is null> : "+userStatus==null);
